...
pulse_VCC = beam.Pulse(beam_params=beam_params, tau=tau, time_window=window, SASE=True, num_spikes=num_spikes, GDD=GDD)
pulse_CC = copy.deepcopy(pulse_VCC)
change_energy(pulse_CC, E1)
...
case_path = path+'ray_tracing_{}THz_diff_chirp/'.format(round(deltaf/1e12)); make_dir(case_path)
