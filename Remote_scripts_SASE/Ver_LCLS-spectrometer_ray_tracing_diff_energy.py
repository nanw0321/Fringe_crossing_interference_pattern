...
devices_CC = define_branch_CC(E0=E1, d23=d23, f_lens=f_lens, FOV1=FOV1, FOV2=FOV2, N=N)
...
case_path = path+'ray_tracing_{}THz_diff/'.format(round(deltaf/1e12)); make_dir(case_path)
